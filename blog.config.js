...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'NotionNext', // 您的昵称 例如 7kami
  BIO: process.env.NEXT_PUBLIC_BIO || '一个无聊的高一生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://github.com/yzkami', // 网站地址
